...
var Database = better_sqlite3.default.default || better_sqlite3.default;
...
var db = new Database(path.default.join(dbDir, "database.sqlite"));
function initDb() {
	db.exec(`
...
function updateDocumentStatus(hash, status) {
	return db.prepare("UPDATE documents SET status = ? WHERE hash = ?").run(status, hash);
}
//#endregion
...
Object.defineProperty(exports, "updateDocumentStatus", {
	enumerable: true,
	get: function() {
